...
\textbf{LUT}           & 6,261    \\
\textbf{DSP}           & 0        \\
\textbf{Memory(BRAM)}  & "666,552 \\
\textbf{Flip-Flop}     & 2,706    \\
\textbf{Frequency}     & 71.31MHz \\
\textbf{Static Power}  & 96.84mW  \\
\textbf{Dynamic Power} & 129.33mW \\
\textbf{Total Power}   & 246.99mW
\end{tabular}
\end{table}
```
